...
CAPABILITY_LABELS: dict[str, dict[str, str]] = {
    "STOCK_KLINE": {"label": "股票 K线", "icon": "📈"},
    "INDEX_KLINE": {"label": "指数 K线", "icon": "📉"},
    "STOCK_REALTIME_QUOTE": {"label": "实时行情", "icon": "💹"},
    "INDEX_REALTIME_QUOTE": {"label": "指数实时", "icon": "📊"},
    "STOCK_LIST": {"label": "股票列表", "icon": "📋"},
    "TRADE_CALENDAR": {"label": "交易日历", "icon": "📅"},
    "STOCK_BOARD": {"label": "板块", "icon": "🏷"},
    "STOCK_ZT_POOL": {"label": "涨跌停股池", "icon": "🚦"},
    "STOCK_ZT_REASON": {"label": "涨停原因", "icon": "💡"},
