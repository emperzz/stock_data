...
def test_all_sources_loop(fresh_db, monkeypatch):
    ...
    total_rows = []
    for src in ("eastmoney", "zhitu", "zzshare"):
        board_code = {"eastmoney": "BK1", "zhitu": "sw1", "zzshare": "th1"}[src]
        total_rows.extend(board_mod.read_membership(board_code=board_code, source=src))
