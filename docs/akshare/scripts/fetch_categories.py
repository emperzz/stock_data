...
CATEGORIES = [
    ...
    (
        "qhkc_commodity",
        "https://akshare.akfamily.xyz/data/qhkc/commodity.html",
        "奇货商品",
        "qhkc_commodity",
    ),
    (
        "qhkc_broker",
        "https://akshare.akfamily.xyz/data/qhkc/broker.html",
        "奇货席位",
        "qhkc_broker",
    ),
    (
        "qhkc_index_data",
        "https://akshare.akfamily.xyz/data/qhkc/index_data.html",
        "奇货指数",
        "qhkc_index_data",
    ),
    (
        "qhkc_fundamental",
        "https://akshare.akfamily.xyz/data/qhkc/fundamental.html",
        "奇货基本面",
        "qhkc_fundamental",
    ),
