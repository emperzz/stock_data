...
| `GET /north-flow/realtime` | NORTH_FLOW | csi | EastMoney | 北向资金（实时） |
...
| `GET /hot-topics` | HOT_TOPICS | csi | Zzshare | 热点题材（带原因标签） |
...
| `GET /stocks/{stock_code}/news` | STOCK_NEWS | csi | EastMoney | 个股资讯 |
