...
| `GET /calendar` | TRADE_CALENDAR | csi | Zzshare / Akshare / Myquant | A 股交易日历 |
...
| `GET /boards/{board_code}/history` | STOCK_BOARD | csi | Ths / EastMoney | 板块 K 线（d/w/m + 5m/15m/30m/60m；ths 额外支持 1m） |
